...
const schema = new mongoose.Schema(
  {
    ...
    seasonalityInIndia: { type: String },
    order: { type: String },
    family: { type: String },
    ...
    weightG: { type: { min: Number, max: Number }, _id: false },
    wingspanCm: { type: { min: Number, max: Number }, _id: false },
    callDescription: { type: String },
    juvenileDescription: { type: String },
    similarSpecies: { type: [String] },
    diet: { type: [String] },
